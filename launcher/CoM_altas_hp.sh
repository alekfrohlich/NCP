...
python ${exec_file} ${hydra_kwargs} ${exp_params} device=0 optim.lr=5e-4 model=NCP architecture.residual_encoder=True   gamma=1,5,10     seed=0,1 &
python ${exec_file} ${hydra_kwargs} ${exp_params} device=1 optim.lr=5e-4 model=NCP architecture.residual_encoder=True   gamma=25,50      seed=0,1 &
python ${exec_file} ${hydra_kwargs} ${exp_params} device=2 optim.lr=5e-4 model=NCP architecture.residual_encoder=True   gamma=100,200    seed=0,1 &
...
python ${exec_file} ${hydra_kwargs} ${exp_params} device=6 optim.lr=5e-4 model=MLP   seed=0 &
python ${exec_file} ${hydra_kwargs} ${exp_params} device=7 optim.lr=5e-4 model=EMLP  seed=0 &
